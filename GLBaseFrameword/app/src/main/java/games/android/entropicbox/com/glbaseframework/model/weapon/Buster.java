...
public class Buster extends Weapon {
    ...
    public Buster(Graphics g) {
        N = g.newPixmap("char_blade_N.png");
        S = g.newPixmap("char_blade_S.png");
        W = g.newPixmap("char_blade_W.png");
        E = g.newPixmap("char_blade_E.png");
        NW = g.newPixmap("char_blade_NW.png");
        NE = g.newPixmap("char_blade_NE.png");
        SW = g.newPixmap("char_blade_SW.png");
        SE = g.newPixmap("char_blade_SE.png");
